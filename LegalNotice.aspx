<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="LegalNotice.aspx.cs" Inherits="LegalNotice" Title="Fabrikam Inc: Legal Notice" %>
  ...
  -->
        <div id="content-side2-three-column">
            ...
            <ul class="list-of-links no-lines">
                <li><a href="#">News Title One</a></li>
                <li><a href="#">News Title Two</a></li>
                <li><a href="#">News Title Three</a></li>
                <li><a href="#">News Title Four</a></li>
            </ul>
            <h2>
                Popular widgets</h2>
            <ul class="list-of-links no-lines">
